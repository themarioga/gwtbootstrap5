...
import org.gwtbootstrap4.client.shared.event.AlertCloseEvent;
import org.gwtbootstrap4.client.shared.event.AlertCloseHandler;
import org.gwtbootstrap4.client.shared.event.AlertClosedEvent;
import org.gwtbootstrap4.client.shared.event.AlertClosedHandler;
...
import org.gwtbootstrap4.client.ui.base.button.CloseButton;
import org.gwtbootstrap4.client.ui.base.helper.StyleHelper;
import org.gwtbootstrap4.client.ui.constants.AlertType;
import org.gwtbootstrap4.client.ui.constants.ButtonDismiss;
 ...
 * @author Sven Jacobs
 * @author Joshua Godi
 * @see org.gwtbootstrap4.client.shared.event.AlertCloseEvent
 * @see org.gwtbootstrap4.client.shared.event.AlertClosedEvent
 */
public class Alert extends Div implements HasWidgets, HasText, HasType<AlertType>, HasResponsiveness {
    ...
    public void setDismissable(final boolean dismissable) {
        if (dismissable) {
            addStyleName(Styles.ALERT_DISMISSIBLE);
            insert(closeButton, (Element) getElement(), 0, true);
        } else {
            removeStyleName(Styles.ALERT_DISMISSIBLE);
